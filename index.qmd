...
<!-- banner section -->
```{=html}
<div class="symposium-overview">
  <div class="symposium-details" aria-label="Symposium details">
    <div class="detail-row">
      <span class="detail-icon" aria-hidden="true"><i class="bi bi-calendar-event"></i></span>
      <div class="detail-text">
        <p class="detail-label">Date</p>
        <p class="detail-value">10-12 November 2026</p>
      </div>
    </div>
    <div class="detail-spacer" aria-hidden="true"></div>
    <div class="detail-row">
      <span class="detail-icon" aria-hidden="true"><i class="bi bi-geo-alt"></i></span>
      <div class="detail-text">
        <p class="detail-label">Location</p>
        <p class="detail-value">Perth, Australia</p>
      </div>
    </div>
    <div class="detail-spacer" aria-hidden="true"></div>
    <div class="detail-row">
      <span class="detail-icon" aria-hidden="true"><i class="bi bi-building"></i></span>
      <div class="detail-text">
        <p class="detail-label">Venue</p>
        <p class="detail-value">QT Hotel</p>
      </div>
    </div>
    <div class="detail-spacer" aria-hidden="true"></div>
    <div class="detail-row">
      <span class="detail-icon" aria-hidden="true"><i class="bi bi-signpost-2"></i></span>
      <div class="detail-text">
        <p class="detail-label">Address</p>
        <p class="detail-value">133 Murray Street, Perth CBD</p>
      </div>
    </div>
  </div>
  <div class="symposium-image-wrap">
    <img src="images/QTPerth.jpg" alt="QT Hotel Perth" class="symposium-image">
  </div>
</div>
```
...
[Upload Your Poster ↗](https://adelaideuniversity.box.com/s/695xdh3wtmjykrd9vrs87xnzzxe5vw1l){.btn .btn-lg role="button" target="_blank" style="background-color: #00808b; color: white; border-color: #00808b"}
